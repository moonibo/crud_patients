...
Route::group(['namespace' => 'App\Http\Controllers', 'middleware' => \App\Http\Middleware\AcceptJson::class], function () {
    ...
    Route::get('/patients/prescribers/set{prescriber_id}', 'PatientController@findPrescriberById')->name('patients_find_prescriber');
    ...
    Route::post('/specialities/update/{id}', 'SpecialityController@update')->name('specialities_update');
    ...
    Route::post('/consultations/update/{id}', 'ConsultationController@update')->name('consultations_update');
    ...
    Route::get('/prescribers/consultation/set{consultation_id}', 'PrescriberController@findConsultationById')->name('prescribers_find_consultation');
    Route::get('/prescribers/speciality/set{speciality_id}', 'PrescriberController@findSpecialityById')->name('prescribers_find_speciality');
    ...
    Route::get('/prescriptions/patient/set{patient_id}', 'PrescriptionController@findPatientById')->name('prescriptions_find_patient');
    Route::get('/prescriptions/consultation/set{consultation_id}', 'PrescriptionController@findConsultationById')->name('prescriptions_find_consultation');
    Route::get('/prescriptions/record/set{record_id}', 'PrescriptionController@findRecordById')->name('prescriptions_find_record');
    Route::post('/prescriptions/store','PrescriptionController@store')->name('prescriptions_store');
    Route::post('/prescriptions/update/{id}', 'PrescriptionController@update')->name('prescriptions_update');
    ...
    Route::get('/records/prescriber/set{prescriber_id}', 'RecordController@findPrescriberById')->name('records_find_prescriber');
    Route::get('/records/patient/set{patient_id}', 'RecordController@findPatientById')->name('records_find_patient');
    Route::get('/records/patient/set{patient_id}', 'RecordController@findPatientById')->name('records_find_patient');
    Route::get('/records/patient&prescriber/set{patient_id}/{prescriber_id}', 'RecordController@showRecordByPatientIdAndPrescriberId')->name('records_find_recordbypatientandprescriberid');
    Route::post('/records/store','RecordController@store')->name('prescriptions_store');
    Route::post('/records/update/{id}', 'RecordController@update')->name('prescriptions_update');
